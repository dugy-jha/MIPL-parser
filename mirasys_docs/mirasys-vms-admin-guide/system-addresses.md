...
Click Add new system address.

Type the new system address (either IP address or DNS name) to the Add field.
...
Click on the Master Server address with the changed IP address.

Click Modify system address .

Type the new IP address or DNS name of the DVR into the Modify system address field.
