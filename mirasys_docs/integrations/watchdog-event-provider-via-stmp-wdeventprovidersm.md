# Watchdog Event Provider via STMP (WDEventProviderSMTP.xml) | Mirasys Help Center

Source: https://documentation.mirasys.com/integrations/integrations/watchdog-event-provider-via-stmp-wdeventprovidersm
